    ...
    <div className="min-h-screen bg-background text-foreground font-body p-4 sm:p-6 md:p-8">
      <main className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex justify-center items-center py-8">
          ...
          >
            <span className="font-headline text-lg font-bold">{t('page.click')}</span>
            <span className="text-sm">{t('page.forNew')}</span>
            <span className="font-headline text-lg font-bold">{t('page.warrior')}</span>
          </button>
        </div>
        ...
        {character && (
          <>
            ...
            <div className="flex justify-around items-center text-center flex-wrap gap-4 text-sm sm:text-base">
              <p>
                <span className="font-bold">{t('page.hp')}</span> <span className="">{character.hitPoints}</span>
              </p>
              <p>
              ...
              <p>
                <span className="font-bold">{t('page.honor')}</span> {character.honor} (
                {t(character.honorStatus)})
              </p>
              <p>
                <span className="font-bold">{t('page.ryo')}</span> {character.ryo}
              </p>
            </div>
            ...
            <div className="grid grid-cols-5 gap-x-8 gap-y-6">
              ...
              <div className="col-span-5 md:col-span-2 space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 pl-2 text-muted-foreground">
                  <li>{t('page.swiftness')}: {character.abilities.swiftness}</li>
                  <li>{t('page.spirit')}: {character.abilities.spirit}</li>
                  <li>{t('page.vigor')}: {character.abilities.vigor}</li>
                  <li>{t('page.resilience')}: {character.abilities.resilience}</li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">
                {character.honourTenets.tenetsList.map((tenet: string) => t(tenet)).join(" • ")}
              </p>
            </div>
